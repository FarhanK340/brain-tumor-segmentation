...
DATASET_ID = "syn59059776" # BraTS 2024

# === Local folder to download to ===
DOWNLOAD_DIR = "./brats_data/brats2024"

# === Login and sync ===
syn = synapseclient.Synapse()
syn.login(authToken=AUTH_TOKEN)

syn60086071 = syn.get(entity='syn60086071', version=2 ) # comment out this line if need to download the all the files
filepath = syn60086071.path
print(f"Downloading BraTS 2025 data from {DATASET_ID} into {DOWNLOAD_DIR} ...")
syncFromSynapse(syn, filepath, path=DOWNLOAD_DIR)
